    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-indigo-50 via-white to-purple-50 text-gray-900 overflow-hidden selection:bg-indigo-500/30 flex items-center justify-center font-sans tracking-tight">
            ...
            <div className="fixed inset-0 z-0">
                ...
                {/* Animated Orbs */}
                <div className="absolute top-1/4 left-1/3 w-[500px] h-[500px] bg-indigo-200/30 rounded-full blur-[120px] animate-pulse" />
                <div className="absolute bottom-1/4 right-1/3 w-[500px] h-[500px] bg-purple-200/20 rounded-full blur-[120px] animate-pulse delay-700" />
            </div>
                ...
                <div className="bg-white/90 border border-indigo-200/50 backdrop-blur-xl rounded-[2.5rem] p-10 shadow-2xl">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <button
                            type="submit"
                            disabled={loading}
                            className="w-full py-4 bg-indigo-600 hover:bg-indigo-500 disabled:opacity-60 text-white font-bold rounded-2xl transition-all duration-300 shadow-[0_0_20px_rgba(79,70,229,0.3)] hover:shadow-[0_0_35px_rgba(79,70,229,0.5)] active:scale-[0.98] mt-4"
                        >
                            {loading ? '登録中...' : '新規登録'}
                        </button>
                    </form>
