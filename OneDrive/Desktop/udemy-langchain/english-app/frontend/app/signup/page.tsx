...
export default function SignupPage() {
    ...
    return (
        <div className="min-h-screen bg-[#0a0c10] text-white overflow-hidden selection:bg-indigo-500/30 flex items-center justify-center font-sans tracking-tight">
            {/* Hero Background Overlay (Shared) */}
            <div className="fixed inset-0 z-0">
                ...
                {/* Animated Orbs */}
                <div className="absolute top-1/4 left-1/3 w-[500px] h-[500px] bg-indigo-600/20 rounded-full blur-[120px] animate-pulse" />
                <div className="absolute bottom-1/4 right-1/3 w-[500px] h-[500px] bg-blue-600/10 rounded-full blur-[120px] animate-pulse delay-700" />
            </div>
            ...
            <div className="relative z-10 w-full max-w-md px-6 animate-fade-in-up">
                <div className="bg-white/5 border border-white/10 backdrop-blur-2xl rounded-[2.5rem] p-10 shadow-2xl">
                    ...
                    <div className="mt-8 text-center text-sm">
                        <span className="text-indigo-100/40">既にアカウントをお持ちですか？</span>
                        <Link
                            href="/login"
